...
class Ui_BrewConfigWindow(object):
    def setupUi(self, BrewConfigWindow):
        ...
        self.QB1Button = QtWidgets.QPushButton(BrewConfigWindow)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.QB1Button.setFont(font)
        self.QB1Button.setObjectName("QB1Button")
        self.horizontalLayout_3.addWidget(self.QB1Button)
        self.QB2Button = QtWidgets.QPushButton(BrewConfigWindow)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.QB2Button.setFont(font)
        self.QB2Button.setObjectName("QB2Button")
        self.horizontalLayout_3.addWidget(self.QB2Button)
        self.QB3Button = QtWidgets.QPushButton(BrewConfigWindow)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.QB3Button.setFont(font)
        self.QB3Button.setObjectName("QB3Button")
        self.horizontalLayout_3.addWidget(self.QB3Button)
        self.QB4Button = QtWidgets.QPushButton(BrewConfigWindow)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.QB4Button.setFont(font)
        self.QB4Button.setObjectName("QB4Button")
        self.horizontalLayout_3.addWidget(self.QB4Button)
        self.QB5Button = QtWidgets.QPushButton(BrewConfigWindow)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.QB5Button.setFont(font)
        self.QB5Button.setObjectName("QB5Button")
        self.horizontalLayout_3.addWidget(self.QB5Button)
        self.QB6Button = QtWidgets.QPushButton(BrewConfigWindow)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.QB6Button.setFont(font)
        self.QB6Button.setObjectName("QB6Button")
        self.horizontalLayout_3.addWidget(self.QB6Button)
        self.BreweButtonLayout.addLayout(self.horizontalLayout_3, 3, 0, 1, 1)
        ...
        self.QBLoadButton.setCheckable(True)
        self.QBLoadButton.setChecked(True)
        ...
        self.QBSaveButton.setCheckable(True)
        self.QBSaveButton.setObjectName("QBSaveButton")
        self.horizontalLayout_2.addWidget(self.QBSaveButton)
        self.BreweButtonLayout.addLayout(self.horizontalLayout_2, 2, 0, 1, 1)
    ...
    def retranslateUi(self, BrewConfigWindow):
        ...
        self.QB1Button.setText(_translate("BrewConfigWindow", "QB #1"))
        self.QB2Button.setText(_translate("BrewConfigWindow", "QB #2"))
        self.QB3Button.setText(_translate("BrewConfigWindow", "QB #3"))
        self.QB4Button.setText(_translate("BrewConfigWindow", "QB #4"))
        self.QB5Button.setText(_translate("BrewConfigWindow", "QB #5"))
        self.QB6Button.setText(_translate("BrewConfigWindow", "QB #6"))
