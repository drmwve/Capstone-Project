...
class DeviceStatus(QtWidgets.QWidget, Ui_DeviceStatus):
    ...
    def __init__(self):
        ...
        self.ballValveButton = [self.BallValve1Button, self.BallValve2Button, self.BallValve3Button, self.BallValve4Button, self.BallValve5Button]
        self.ballValveState = [self.BallValve1State, self.BallValve2State, self.BallValve3State, self.BallValve4State, self.BallValve5State]
        self.threeWayValveButton = [self.ThreeWay1Button, self.ThreeWay2Button, self.ThreeWay3Button, self.ThreeWay4Button, self.ThreeWay5Button]
        self.threeWayValveState = [self.ThreeWay1State, self.ThreeWay2State, self.ThreeWay3State, self.ThreeWay4State, self.ThreeWay5State]
        self.heaterButton = [self.Heater1Button, self.Heater2Button, self.Heater3Button, self.Heater4Button]
        self.heaterState = [self.Heater1State, self.Heater2State, self.Heater3State, self.Heater4State]
