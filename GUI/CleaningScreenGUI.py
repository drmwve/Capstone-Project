...
class Ui_CleaningScreen(object):
    def setupUi(self, CleaningScreen):
        ...
        self.pushButton = QtWidgets.QPushButton(CleaningScreen)
        ...
        self.StartCleaningButtonLayout.addWidget(self.pushButton)
    ...
    def retranslateUi(self, CleaningScreen):
        ...
        self.pushButton.setText(_translate("CleaningScreen", "Start Cleaning Cycle"))
